...
render(){
  return(
    ...
    <Container>
      ...
      <iframe autoPlay src="https://player.vimeo.com/video/253155284?title=0&byline=0&portrait=0" width="100%" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        </Col>
        <Col xs="4">
